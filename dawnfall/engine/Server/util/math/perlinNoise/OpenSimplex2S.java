package com.dawnfall.engine.Server.util.math.perlinNoise;
...
public class OpenSimplex2S {
    ...
    /**
     * 2D OpenSimplex2S/SuperSimplex noise, with Y pointing down the dawnStar diagonal.
     ...
     * If Y is vertical in world coordinates, call noise3_ImproveXZ(xC, zC, Y) or use noise3_XZBeforeY.
     * If Z is vertical in world coordinates, call noise3_ImproveXZ(xC, y, Z).
     * For a time varied animation, call noise3_ImproveXY(xC, y, T).
     */
    public static float noise3_ImproveXY(long seed, double x, double y, double z) {

        // Re-orient the cubic lattices without skewing, so Z points up the dawnStar lattice diagonal,
     ...
     * If Y is vertical in world coordinates, call noise3_ImproveXZ(xC, Y, zC).
     * If Z is vertical in world coordinates, call noise3_ImproveXZ(xC, Z, y) or use noise3_ImproveXY.
     * For a time varied animation, call noise3_ImproveXZ(xC, T, y) or use noise3_ImproveXY.
     */
    public static float noise3_ImproveXZ(long seed, double x, double y, double z) {

        // Re-orient the cubic lattices without skewing, so Y points up the dawnStar lattice diagonal,
     ...
     * Recommended for noise(xC, y, sin(time), cos(time)) trick.
     */
